...
module.exports = {
  maxScrollbarLength: 66, // null
  minScrollbarLength: 66, //null 
...
function Instance(element) {
  ...
  d.css(i.scrollbarYRail, 'display', 'block');
  d.css(i.scrollbarYRail, 'background-color', '#dadada');
  d.css(i.scrollbarYRail, 'width', '22px');
  i.railYHeight = "100%";
  i.railYRatio = null;
}
...
module.exports = function (element) {
  ...
  if (!i.settings.suppressScrollY && i.containerHeight + i.settings.scrollYMarginOffset < i.contentHeight) {
    ...
    i.scrollbarYHeight = i.settings.minScrollbarLength;
    i.scrollbarYTop = 0;
